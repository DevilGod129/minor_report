...
\pagecolor{white} % Sets the entire page background to white

\usepackage{graphicx}
% Add to your main document preamble
\usepackage{tikz}
\usetikzlibrary{shapes.geometric,arrows.meta,positioning,shapes,arrows,fit}
\tikzset{
...
%\chapter{Work Completed and Work Remaining}
%\label{workcompleted}
%\input{chapters/ch7workcompleted}
...
\label{softwareimplementation}
\input{chapters/software_implementation}

\chapter{Face Recognition System}
