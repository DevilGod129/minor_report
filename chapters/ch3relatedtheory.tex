...
\begin{figure}[H]
    ...
    \caption{Johnson Motor (Source: [4])}
    \label{fig:3.1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Raspberry Pi 3 (Source: [5])}
    \label{fig:3.2}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Metal Gear Servo MG996R (Source: [8])}
    \label{fig:3.5}
\end{figure}
\newpage
\section{Software}
