...
\section{Scope}
This project is focused on creating a prototype of a healthcare delivery robot optimized for structured environments like hospital wards and old age homes. The scope includes:
\begin{itemize}
...
This project focuses on developing a practical and scalable solution by integrating artificial intelligence, embedded systems, and web technologies into a unified healthcare system.