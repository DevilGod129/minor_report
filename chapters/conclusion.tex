...
The system design, implementation, and evaluation discussed in Chapters \ref{methodology} to \ref{result} collectively demonstrate the effectiveness of the proposed solution.
